...
export type CustomSenderApi_SendMessageForAlertRequestBody =
  Partial<ModelSendMessageForAlertRequest> &
    ModelSendMessageForAlertRequest_partial;

export type CustomSenderApi_SendMessageForAlertResponseBody =
